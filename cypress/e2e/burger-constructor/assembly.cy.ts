...
describe('Burger constructor', () => {
  ...
  it('should show bun on both sides after adding', () => {
    ...
    cy.get(DATA_SELECTORS.BURGER_CONSTRUCTOR).within(() => {
      cy.get(CLASS_SELECTORS.TOP_BUN).should(
        'contain',
        INGREDIENTS_TEXTS.BUN_FLUORESCENT
      );

      cy.get(CLASS_SELECTORS.BOTTOM_BUN).should(
        'contain',
        INGREDIENTS_TEXTS.BUN_FLUORESCENT
      );
    });
  ...
  it('should show bun and ingredient after adding', () => {
    ...
    const ingredientItem = cy
      .contains(INGREDIENTS_TEXTS.INGREDIENT_MAGNOLIA)
      .parent('li');
